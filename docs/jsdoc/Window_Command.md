...
#### (abstract) new Window_Command (x, y)
 ...
 コマンド選択用ウィンドウ。 [Window_ActorCommand](Window_ActorCommand.html), [Window_ChoiceList](Window_ChoiceList.html), [Window_GameEnd](Window_GameEnd.html), [Window_MenuCommand](Window_MenuCommand.html), [Window_Options](Window_Options.html), [Window_SkillType](Window_SkillType.html), [Window_PartyCommand](Window_PartyCommand.html), [Window_TitleCommand](Window_TitleCommand.html) と [Window_HorzCommand](Window_HorzCommand.html) のスーパークラス。
