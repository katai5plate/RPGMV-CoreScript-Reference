...
| Name | Type | Description |
| --- | --- | --- |
| `name` | [String](S[Number](Number.md)
...
#### findSymbol (symbol) →[String](String.md)l)}
...
[Number](Number.md)
Returns [Number](Number.md) completely closed (openness == 0).
<dl>
                <dt>Inherited From:</dt>
                <dd>
                    <ul>
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
             [String](String.md)dow_Selectable#isCurrentItemEnabled</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
Creates a new rectang[Number](Number.md) and itemHeight. The rectangle is mainly used for positioning items within the selectable window.
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
                   [Number](Number.md)lectable#maxCols</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
                        [String](String.md)ble#maxPageRows</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
                            <a>Window_Base#[String](String.md)
                        </li>
                    </ul>
                </dd>
            </dl>
...
#### playBuzzerS[MV.TextState](MV.TextState.md)
...
Returns the[String](String.md)css color string.
<dl>[MV.TextState](MV.TextState.md)
                <dt>Inherited From:</dt>
                <dd>
                    <ul>
...
#### textCol[Game_Actor](Game_Actor.md)
