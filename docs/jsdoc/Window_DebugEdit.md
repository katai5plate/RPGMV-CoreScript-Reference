...
| Name | Type | Description |
| --- | --- | --- |
| `_mode` | [String](String.html) |  |
| `_topId` | [Number](Number.html) |  |
...
#### itemName (dataId) → {[String](String.html)}

##### Parameters:

| Name | Type | Description |
| --- | --- | --- |
| `dataId` | [Number](Number.html) |  |
...
#### itemStatus (dataId) → {[String](String.html)}
