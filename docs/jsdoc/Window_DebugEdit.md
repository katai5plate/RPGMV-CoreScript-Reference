...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
                     [Number](Number.md)ctable#itemRect</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
Creates a [Number](Number.md)symbol as the handler name and a method (JS function) bound to it.
