...
## Window_ChoiceList (messageWindow)
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
                            <a>Window_Command#callCancelHandler</a>
                        </li>
                    </ul>
             [String](String.md)
            </dl>
...
<dl>
                ...
                <dd>
                    <ul>[Number](Number.md)
                        <li>
                            <a>Window_Command#contentsHeight</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
                     [String](String.md)ctable#deselect</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
            [Game_Actor](Game_Actor.md)e#drawActorName</a>
        [Number](Number.md)
        [Number](Number.md)
            [Number](Number.md)
            </dl>
...
<dl>
        ...
        [Number](Number.md)
        [Number](Number.md)
            [Number](Number.md)ndow_Base#drawCharacter</a>
             [String](String.md)
             [String](String.md)
                </dd>
            </dl>
...
<dl>[String](String.md)
        ...
        [Number](Number.md)
            [Number](Number.md)
             [Number](Number.md)dow_Base#drawCurrencyValue</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
| Name | Type | Description |
| --- | --- | --- |
| `symbol` | [String](Stri[String](String.md)
...
<dl>
                <dt> Type </dt>
                <dd>[Window_Message](Window_Message.md)
                    <span><a>String</a></span>
                </dd>
            </dl>
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
                            <a>Window_Command#isCancelEnabled</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
                            <a>Window_Command#isOkTriggered</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
            [Number](Number.md)ndow_Selectable#isTouchedInsideFrame</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
Returns the standard line [Number](Number.md) window; default is 36.
<dl>
                <dt>Inherited From:</dt>
                <dd>
                    <ul>
...
Resets the te[String](String.md)w back to the default.
<dl>
                <dt>Inherited From:</dt>
                <dd>
                    <ul>
