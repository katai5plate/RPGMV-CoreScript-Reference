...
| `RUSSIA` | [Array](Array.md).&lt;[String](String.md)&gt; | [static] キリル文字の配列 |
| `JAPAN1` | [Array](Array.md).&lt;[String](String.md)&gt; | [static] ひらがなの配列 |
| `JAPAN2` | [Array](Array.md).&lt;[String](String.md)&gt; | [static] カタカナの配列 |
| `JAPAN3` | [Array](Array.md).&lt;[String](String.md)&gt; | [static] 全角英数字の配列 |
| `_editWindow` | [Window_NameEdit](Window_NameEdit.md) | 編集ウィンドウ |
| `_page` | [Number](Number.md) | ページ番号 |
