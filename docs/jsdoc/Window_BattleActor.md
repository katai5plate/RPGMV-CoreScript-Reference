...
- [basicAreaRect (index)](Window_BattleStatus.md#basicarearect-index--rectangle)
- [drawBasicArea (rect, actor)](Window_BattleStatus.md#drawbasicarea-rect-actor)
- [drawGaugeArea (rect, actor)](Window_BattleStatus.md#drawgaugearea-rect-actor)
- [drawGaugeAreaWithoutTp (rect, actor)](Window_BattleStatus.md#drawgaugeareawithouttp-rect-actor)
- [drawGaugeAreaWithTp (rect, actor)](Window_BattleStatus.md#drawgaugeareawithtp-rect-actor)
- [drawItem (index)](Window_BattleStatus.md#Window_BattleStatus.md#drawitem-index)
- [gaugeAreaRect (index)](Window_BattleStatus.md#gaugearearect-index--rectangle)
- [gaugeAreaWidth () ](Window_BattleStatus.md#gaugeareawidth---number)
- [maxItems ()](Window_BattleStatus.md#maxitems---number)
- [numVisibleRows ()](Window_BattleStatus.md#numvisiblerows---number)
- [refresh ()](Window_BattleStatus.md#refresh-)
- [windowHeight ()](Window_BattleStatus.md#windowheight---number)
