...
The window for selecting an item on the item screen. Super class of [Window_BattleItem](Window_BattleItem.md), [Window_EquipItem](Window_EquipItem.md), [Window_EventItem](Window_EventItem.md), [Window_ShopSell](Window_ShopSell.md)
...
<dl>
                <dt> Type </dt>
                <dd>
            [Number](Number.md)BaseItem</a></span>
                </dd>
            </dl>
...
Returns the mp g[MV.TextState](MV.TextState.md)g.
<dl>
                <dt>Inherited From:</dt>
                <dd>
                    <ul>
...
#### needsNumber[MV.TextState](MV.TextState.md)
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
        [Number](Number.md)a>Window_Selectable#select</a>
        [Number](Number.md)
            [Number](Number.md)
             [Number](Number.md)
            </dl>
...
Sets the p[Number](Number.md)d cursor.
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
                            <a>[Number](Number.md)HelpWindowItem</a>
                        </li>
                    </ul>
                </dd>
            </dl>
