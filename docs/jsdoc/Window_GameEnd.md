...
* [currentData () → {Object}](Window_Command.md#currentdata---object)
* [currentExt () → {*|Object}](Window_Command.md#currentext---object)
...
* [isCommandEnabled (index) → {Boolean}](Window_Command.md#iscommandenabled-index--boolean)
* [isCurrentItemEnabled () → {Boolean}](Window_Command.md#iscurrentitemenabled---boolean)
* [isOkEnabled () → {Boolean}](Window_Command.md#isokenabled---boolean)
