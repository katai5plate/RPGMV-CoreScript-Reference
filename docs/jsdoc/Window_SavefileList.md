...
## Window_SavefileList (x, y, width, height)
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
           [Rectangle](Rectangle.md)Selectable#drawAllItems</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
| Name | Type | Description |
| --- | --- [Number](Number.md)
| `characte[String](String.md)ing.md) |  |
...
Draws th[Number](Number.md)ecified x and y coordinates within the given width.
[Number](Number.md)
...
Draws the current playtime at the specified x and y coordinates within the given width.
...
#### hpG[Number](Number.md)ing](String.md)}
[Number](Number.md)
[Number](Number.md)
Returns the h[Number](Number.md)css color string.
<dl>
                <dt>Inherited From:</dt>
                <dd>
                    <ul>
...
Makes the font bigger by[Number](Number.md)
<dl>
                <dt>Inherited From:</dt>
                <dd>
                    <ul>
...
Sets the x, y, width, and[String](String.md)
...
Resets the[Number](Number.md)ndow back to the default.
<dl>
                <dt>Inherited From:</dt>
                <dd>
                    <ul>
...
[Number](Number.md)
[Number](Number.md)
Selects the [Number](Number.md)the window given a number.
[Number](Number.md)
##### Parameters:
...
Sets the back[String](String.md)ndow. 0 is 255 window opacity (standard). 1 is the window with background dimmer. Any other number changes the opacity to 0.
...
Sets the _c[String](String.md)f the window.
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
           [String](String.md)indow_Base#standardFontSize</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
Returns a text color giv[String](String.md)s a css color string; this index maps directly to the img/system/window.png colors by default.
