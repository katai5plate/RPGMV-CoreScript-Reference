...
| `_tempActor` | [Game_Actor](Game_Actor.md) |  |
...
<dl>
        ...
        [Number](Number.md)
[Number](Number.md)
#### drawCurre[Number](Number.md)x, x, y, width, color1, color2)
...
<dl>
        ...
        [Number](Number.md)
        [Number](Number.md)
              [Number](Number.md)ow_Base#drawGauge</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
#### removeC[Game_Actor](Game_Actor.md)
