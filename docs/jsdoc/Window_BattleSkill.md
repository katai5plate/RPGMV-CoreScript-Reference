...
## Window_BattleSkill (x, y, width, height)
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
                            <a>Window_SkillList#costWidth</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
<dl>
        ...
        [Number](Number.md)
                        <li>
                            <a>Window_SkillList#drawSkillCost</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
Hides the at[Game_Actor](Game_Actor.md)
<dl>
                <dt>Inherited From:</dt>
                <dd>
                    <ul>
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
                            <a>Window_SkillList#initialize</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
                            <a>Window_SkillList#isCurrentItemEnabled</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
                            <a>Window_SkillList#isEnabled</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
#### makeFontSmaller ()[Number](Number.md)
...
<dl>
                ...
                <dd>
                    <ul[Number](Number.md)
                        <li>
                            <a>Window_SkillList#makeItemList</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
                [MV.TextState](MV.TextState.md)sDrawIcon</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
                            <a>Window_SkillList#selectLast</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
[Number](Number.md)
[Number](Number.md)
Sets the curr[Number](Number.md)l list window.
...
[Number](Number.md)
[Number](Number.md)
Sets the[Number](Number.md)and cursor.
...
<dl>
                ...
                <dd>
                    <ul>[Number](Number.md)
                        <li>
                            <a>Window_SkillList#setStypeId</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
                            <a>Window_SkillList#updateHelp</a>
                        </li>
                    </ul>
                </dd>
            </dl>
