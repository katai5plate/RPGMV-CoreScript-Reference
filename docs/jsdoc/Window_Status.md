...
| Name | Type | Desc[String](String.md)
| --- | --- | --- |[Number](Number.md)
| `y` | [Number](Number.md) |  |
[Number](Number.md)
<dl>
...
Makes the font smaller b[Number](Number.md)
<dl>
                <dt>Inherited From:</dt>
                <dd>
                    <ul>
...
#### maxEquipmentLines () → {[Number](Number.html)}
