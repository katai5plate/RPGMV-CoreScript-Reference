...
#### addMainCommands ()
[メニューコマンド]でチェックされているならメインコマンド( [アイテム][スキル][装備][ステータス] )を追加。


#### addOriginalCommands ()
プラグインでオリジナルのコマンドを追加する際に利用。


#### addOptionsCommand ()
利用可能なら[オプション]コマンドを追加。


#### addSaveCommand ()
[メニューコマンド]でチェックされているなら[セーブ]コマンドを追加。


#### addGameEndCommand ()
ゲーム終了可能なら[ゲーム終了]コマンドを追加。


#### areMainCommandsEnabled () → {Boolean}
メインコマンド( [アイテム][スキル][装備][ステータス] )が使用可能(パーティメンバがいる)か。
...
[メニューコマンド]でチェックされているかつパーティメンバーが複数いて、[並べ替え]が利用可能か。


#### isGameEndEnabled () → {Boolean}
[ゲーム終了]が利用可能か(規定値: true)


#### isOptionsEnabled () → {Boolean}
[オプション]が利用可能か(規定値: true)


#### isSaveEnabled () → {Boolean}
[メニューコマンド]でチェックされているかつイベントの[テスト]実行ではなく、[セーブ]が利用可能か。
